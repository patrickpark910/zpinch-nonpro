...
# --- Input inventory ---
INPUT_CSV = "eol_inventory_tracked.csv"
OUTPUT_CSV = "bol_inventory_zpinch.csv"
...
# --- Output directories ---
OPENMC_DIR  = "OpenMC"      # XMLs, H5s, all OpenMC working files
...
def post_process(nuclide_atoms):
    ...
    csv_full = os.path.join(RESULTS_DIR, "delta_inventory.csv")
