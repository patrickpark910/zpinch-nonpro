...
OUTPUT_DIR = f"uzr_sigma_pile_results_slab{f'{FUEL_SLAB_THICKNESS:.0f}'.zfill(2)}cm"
...
def run_case(slab_midpoint, pbli_mat, fuel_mat, run_index):
    ...
    if no_fuel:
        ...
        case_dir = os.path.join(OUTPUT_DIR, f"uzr_case_{run_index:03d}_mid_{slab_midpoint:.1f}cm")
...
def plot_results(all_results):
    ...
    plot_path = os.path.join(OUTPUT_DIR, "uzr_sigma_pile_sensitivity.png")
    ...
    if fuel_only:
        ...
        spec_path = os.path.join(OUTPUT_DIR, "uzr_fuel_spectra_vs_position.png")
...
def plot_mesh_profiles(all_results):
    ...
    mesh_plot_path = os.path.join(OUTPUT_DIR, "uzr_mesh_depth_profiles.png")
    ...
    if found_current:
        ...
        current_path = os.path.join(OUTPUT_DIR, "uzr_mesh_z_current_profile.png")
...
def plot_neutron_balance(all_results):
    ...
    for ci in indices:
        ...
        plot_path = os.path.join(OUTPUT_DIR, f"uzr_neutron_balance_mid{midpt:.0f}cm.png")
        fig.savefig(plot_path, dpi=200)
...
def plot_cumulative_neutron_balance(all_results):
    ...
    for ci in indices:
        ...
        plot_path = os.path.join(OUTPUT_DIR, f"uzr_cumulative_nbal_mid{midpt:.0f}cm.png")
        fig.savefig(plot_path, dpi=200)
...
def main():
    ...
    json_path = os.path.join(OUTPUT_DIR, "uzr_all_results.json")
